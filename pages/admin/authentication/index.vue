...
<template>
  <section class="login_section authentication-bg">
        ...
        <div class="row justify-content-center">
          <div class="col-xl-12">
                ...
                <div class="row align-items-center g-0">
                  <div class="col-lg-6 d-none d-lg-inline-block border-end">
                    <div class="auth-page-sidebar">
                      <img
                        src="assets/admin/images/auth/sign-in.svg"
                        alt="auth"
                        class="img-fluid"
                      />
                    </div>
                    ...
                    <div class="p-4">
                      <div class="mx-auto mb-4 text-center auth-logo">
                        <a href="index.html" class="logo-dark">
                          <img
                            src="assets/admin/images/auth/logo-sm.png"
                            height="30"
                            class="me-1"
                            alt="logo sm"
                          />
                          <img
                            src="assets/admin/images/auth/logo-dark.png"
                            height="24"
                            alt="logo dark"
                          />
                        </a>
                        ...
                        <a href="index.html" class="logo-light">
                          ...
                          />
                          <img
                            src="assets/admin/images/auth/logo-light.png"
                            height="24"
                            alt="logo light"
                          />
                        </a>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-12 col-md-8">
                          <form
                            action="https://techzaa.in/reback/admin/index.html"
            ...
            <p class="text-white mb-0 text-center">
              ...
              <a href="auth-signup.html" class="text-white fw-bold ms-1"
                >Sign Up</a
              >
            </p>
          </div>
